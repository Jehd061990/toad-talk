...
const DeleteMembers = () => {
  return (
    <>
      ...
      <button
        onClick={() => document.getElementById("deleteMember").showModal()}
      >
      ...
      <dialog id="deleteMember" className="modal">
        <div className="modal-box">
          <div className="flex flex-row justify-between">
            <h3 className="font-bold text-lg">Delete Members</h3>
            <div>
              <form method="dialog">
            ...
            <div className="text-lg h-60vh  w-auto flex flex-col gap-2 ">
              <div className="form-control">
                <label className="cursor-pointer label">
                  ...
                  <input
                    type="checkbox"
                    className="ms-2 checkbox checkbox-warning"
                  />
                </label>
...
const DesktopDeleteMember = () => {
  return (
    <>
      {/* Open the modal using document.getElementById('ID').showModal() method */}
      <button
        onClick={() =>
          document.getElementById("deleteDesktopMember").showModal()
        }
      >
        <span className="material-symbols-outlined me-2">delete</span>
      </button>
      <dialog id="deleteDesktopMember" className="modal">
        <div className="modal-box">
          <div className="flex flex-row justify-between">
            <h3 className="font-bold text-lg">Delete Members</h3>
            <div>
...
export { DeleteMembers, DesktopDeleteMember };
