        ...
        <div className="convo-wrapper overflow-y-scroll">
          ...
          <div className="chat chat-start">
            ...
            <div className="chat-bubble">
              ...
              corporis nostrum eum praesentium ipsam porro quibusdam laboriosam,
              maxime iure est excepturi sapiente cum. Dolores, pariatur unde!
            </div>
            <div className="chat-footer opacity-50">Delivered</div>
          </div>
          ...
          <div className="chat chat-end">
            ...
            <div className="chat-bubble">
              ...
              Suscipit obcaecati exercitationem ullam voluptate possimus beatae
              assumenda, et animi doloribus molestias ipsa, explicabo nesciunt
              totam necessitatibus. Aspernatur, modi.
            </div>
            <div className="chat-footer opacity-50">Seen at 12:46</div>
          </div>
